...
//     (\`new LoremPicsumSDK(...)\` / \`LoremPicsumSDK.test(...)\` become
//     \`LoremPicsumSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"get_random_image":{"test01":{"id":"test01"}},"get_random_square_image":{"test01":{"id":"test01"}},"height":{"test01":{"id":"test01"}},"heightwebp":{"test01":{"id":"test01"}},"id_info":{"test01":{"id":"test01"}},"idn":{"test01":{"id":"test01"}},"list":{"test01":{"id":"test01"}},"seed":{"test01":{"id":"test01"}},"seed_info":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new LoremPicsumSDK(...)\` and any
// \`LoremPicsumSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+LoremPicsumSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/LoremPicsumSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
