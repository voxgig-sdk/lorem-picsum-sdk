...
(0, node_test_1.describe)('HeightwebpDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-heightwebp', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-heightwebp', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["width01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_HEIGHTWEBP_ENTID'];
...
//# sourceMappingURL=HeightwebpDirect.test.js.map