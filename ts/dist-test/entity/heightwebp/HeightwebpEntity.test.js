...
(0, node_test_1.describe)('HeightwebpEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'heightwebp.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set LOREM_PICSUM_TEST_HEIGHTWEBP_ENTID JSON to run live');
            return;
        }
        ...
        let heightwebp_ref01_data = Object.values(setup.data.existing.heightwebp)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/heightwebp/HeightwebpTestData.json');
    ...
    let idmap = transform(['heightwebp01', 'heightwebp02', 'heightwebp03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LOREM_PICSUM_TEST_HEIGHTWEBP_ENTID'];
...
//# sourceMappingURL=HeightwebpEntity.test.js.map