...
(0, node_test_1.describe)('GetRandomSquareImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_random_square_image.' + op, live))
                return;
        }
        ...
        let get_random_square_image_ref01_data = Object.values(setup.data.existing.get_random_square_image)[0];
        // LOAD
        const get_random_square_image_ref01_ent = client.GetRandomSquareImage();
        const get_random_square_image_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(get_random_square_image_ref01_data_dt0.id === get_random_square_image_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_random_square_image/GetRandomSquareImageTestData.json');
    ...
    let idmap = transform(['get_random_square_image01', 'get_random_square_image02', 'get_random_square_image03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LOREM_PICSUM_TEST_GET_RANDOM_SQUARE_IMAGE_ENTID'];
...
//# sourceMappingURL=GetRandomSquareImageEntity.test.js.map