...
(0, node_test_1.describe)('GetRandomSquareImageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_random_square_image', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_random_square_image', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_GET_RANDOM_SQUARE_IMAGE_ENTID'];
...
//# sourceMappingURL=GetRandomSquareImageDirect.test.js.map