...
(0, node_test_1.describe)('SeedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-seed', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-seed', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["height01", "seed01", "width01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.seed = 'direct02';
            params.width = 'direct03';
        }
        const result = await client.direct({
            path: 'seed/{seed}/{width}/{height}',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_SEED_ENTID'];
...
//# sourceMappingURL=SeedDirect.test.js.map