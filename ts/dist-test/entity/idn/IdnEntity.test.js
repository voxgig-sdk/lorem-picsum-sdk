...
(0, node_test_1.describe)('IdnEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'idn.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set LOREM_PICSUM_TEST_IDN_ENTID JSON to run live');
            return;
        }
        ...
        let idn_ref01_data = Object.values(setup.data.existing.idn)[0];
        // LOAD
        const idn_ref01_ent = client.Idn();
        const idn_ref01_match_dt0 = {};
        idn_ref01_match_dt0.id = idn_ref01_data.id;
        const idn_ref01_data_dt0 = (await idn_ref01_ent.load(idn_ref01_match_dt0)).data();
        (0, node_assert_1.default)(idn_ref01_data_dt0.id === idn_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/idn/IdnTestData.json');
    ...
    let idmap = transform(['idn01', 'idn02', 'idn03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LOREM_PICSUM_TEST_IDN_ENTID'];
...
//# sourceMappingURL=IdnEntity.test.js.map