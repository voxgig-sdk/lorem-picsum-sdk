...
(0, node_test_1.describe)('IdnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-idn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-idn', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["height01", "id01", "width01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_IDN_ENTID'];
...
//# sourceMappingURL=IdnDirect.test.js.map