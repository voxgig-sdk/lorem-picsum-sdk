...
(0, node_test_1.describe)('GetRandomImageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'get_random_image.' + op, live))
                return;
        }
        ...
        let get_random_image_ref01_data = Object.values(setup.data.existing.get_random_image)[0];
        // LOAD
        const get_random_image_ref01_ent = client.GetRandomImage();
        const get_random_image_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(get_random_image_ref01_data_dt0.id === get_random_image_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_random_image/GetRandomImageTestData.json');
    ...
    let idmap = transform(['get_random_image01', 'get_random_image02', 'get_random_image03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['LOREM_PICSUM_TEST_GET_RANDOM_IMAGE_ENTID'];
...
//# sourceMappingURL=GetRandomImageEntity.test.js.map