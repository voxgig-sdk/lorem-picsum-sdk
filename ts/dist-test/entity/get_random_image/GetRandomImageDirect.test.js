...
(0, node_test_1.describe)('GetRandomImageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.LoremPicsumSDK({
    ...
    (0, node_test_1.test)('direct-load-get_random_image', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_random_image', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["height01", "width01"]))
            return;
...
function liveScenariosActive() { return false && process.env.LOREM_PICSUM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LoremPicsumSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['LOREM_PICSUM_TEST_GET_RANDOM_IMAGE_ENTID'];
    ...
    const client = new __1.LoremPicsumSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomImageDirect.test.js.map