...
(0, node_test_1.describe)('HeightDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-height', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-height', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_HEIGHT_ENTID'];
...
//# sourceMappingURL=HeightDirect.test.js.map