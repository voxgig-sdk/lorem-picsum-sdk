...
(0, node_test_1.describe)('IdInfoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'id_info.' + op, live))
                return;
        }
        ...
        let id_info_ref01_data = Object.values(setup.data.existing.id_info)[0];
        // LOAD
        const id_info_ref01_ent = client.IdInfo();
        const id_info_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(id_info_ref01_data_dt0.id === id_info_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/id_info/IdInfoTestData.json');
    ...
    let idmap = transform(['id_info01', 'id_info02', 'id_info03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=IdInfoEntity.test.js.map