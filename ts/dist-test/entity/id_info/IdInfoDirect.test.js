...
(0, node_test_1.describe)('IdInfoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-id_info', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-id_info', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['LOREM_PICSUM_TEST_ID_INFO_ENTID'];
...
//# sourceMappingURL=IdInfoDirect.test.js.map