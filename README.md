...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/lorem-picsum` | `npm install @voxgig-sdk/lorem-picsum` |
| Python | `voxgig-sdk-lorem-picsum` | `pip install voxgig-sdk-lorem-picsum` |
| PHP | `voxgig-sdk/lorem-picsum` | `composer require voxgig-sdk/lorem-picsum` |
| Golang | `github.com/voxgig-sdk/lorem-picsum-sdk/go` | `go get github.com/voxgig-sdk/lorem-picsum-sdk/go` |
| Ruby | `voxgig-sdk-lorem-picsum` | `gem install voxgig-sdk-lorem-picsum` |
| Lua | `voxgig-sdk-lorem-picsum` | `luarocks install voxgig-sdk-lorem-picsum` |
