...
// LoremPicsum SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LoremPicsumOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LoremPicsumOmni::structfix($now, Struct::undef()))
                        !== json_encode(LoremPicsumOmni::structfix($val, Struct::undef()))) {
