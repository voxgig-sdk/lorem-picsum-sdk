...
class HeightDirectTest extends TestCase
{
    public function test_direct_load_height(): void
    {
        $setup = height_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-height", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
