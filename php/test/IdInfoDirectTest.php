...
class IdInfoDirectTest extends TestCase
{
    public function test_direct_load_id_info(): void
    {
        $setup = id_info_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-id_info", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
