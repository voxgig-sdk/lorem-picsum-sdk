...
// LoremPicsum SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LoremPicsumSDK::test)
...
{
    private const SDK_CLASS = 'LoremPicsumSDK';
    ...
    private const SDK_BASE = 'lorempicsum_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../lorempicsum_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
