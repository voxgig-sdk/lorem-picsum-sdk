...
class SeedInfoDirectTest extends TestCase
{
    public function test_direct_load_seed_info(): void
    {
        $setup = seed_info_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-seed_info", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
