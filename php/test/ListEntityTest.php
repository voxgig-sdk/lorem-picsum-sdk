...
class ListEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LOREMPICSUM_TEST_LIST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function list_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LOREMPICSUM_TEST_LIST_ENTID");
