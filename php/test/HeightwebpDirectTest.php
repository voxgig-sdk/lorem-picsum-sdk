...
class HeightwebpDirectTest extends TestCase
{
    public function test_direct_load_heightwebp(): void
    {
        $setup = heightwebp_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-heightwebp", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
