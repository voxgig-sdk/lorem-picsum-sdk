...
class IdnDirectTest extends TestCase
{
    public function test_direct_load_idn(): void
    {
        $setup = idn_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-idn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
