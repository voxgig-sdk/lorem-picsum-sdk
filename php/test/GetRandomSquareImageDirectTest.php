...
class GetRandomSquareImageDirectTest extends TestCase
{
    public function test_direct_load_get_random_square_image(): void
    {
        $setup = get_random_square_image_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_random_square_image", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
