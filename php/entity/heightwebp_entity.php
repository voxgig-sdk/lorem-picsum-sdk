...
// LoremPicsum SDK Heightwebp entity
...
class HeightwebpEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HeightwebpEntity($this->_client, $opts);
    }

    /**
     * @param Heightwebp|array $args Heightwebp data (assoc-array) to store.
     */
    ...
    /**
     * @return Heightwebp|array The current Heightwebp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Heightwebp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Heightwebp fields).
     */
    ...
    /**
     * Load a single Heightwebp.
     *
     * @param HeightwebpLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HeightwebpLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Heightwebp|array The loaded Heightwebp as an assoc-array at the
