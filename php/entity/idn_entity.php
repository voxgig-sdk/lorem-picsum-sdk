...
class IdnEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IdnEntity($this->_client, $opts);
    }

    /**
     * @param Idn|array $args Idn data (assoc-array) to store.
     */
    ...
    /**
     * @return Idn|array The current Idn data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Idn fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Idn fields).
     */
     ...
     * Load a single Idn.
     *
     * @param IdnLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IdnLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Idn|array The loaded Idn as an assoc-array at the
