...
// LoremPicsum SDK SeedInfo entity
...
class SeedInfoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SeedInfoEntity($this->_client, $opts);
    }

    /**
     * @param SeedInfo|array $args SeedInfo data (assoc-array) to store.
     */
    ...
    /**
     * @return SeedInfo|array The current SeedInfo data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SeedInfo fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SeedInfo fields).
     */
     ...
     *
     * @param SeedInfoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SeedInfoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SeedInfo|array The loaded SeedInfo as an assoc-array at the
