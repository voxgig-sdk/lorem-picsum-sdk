...
class HeightEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HeightEntity($this->_client, $opts);
    }

    /**
     * @param Height|array $args Height data (assoc-array) to store.
     */
    ...
    /**
     * @return Height|array The current Height data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Height fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Height fields).
     */
    ...
    /**
     * Load a single Height.
     *
     * @param HeightLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HeightLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Height|array The loaded Height as an assoc-array at the
