...
// LoremPicsum SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LoremPicsumTransformResponse
{
    public static function call(LoremPicsumContext $ctx): mixed
    {
        ...
        $transform = LoremPicsumHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
