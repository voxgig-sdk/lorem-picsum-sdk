...
// LoremPicsum SDK utility: fetcher

class LoremPicsumFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LoremPicsumSDK/1.0)';
    ...
    public static function call(LoremPicsumContext $ctx, string $fullurl, array $fetchdef): array
    {
