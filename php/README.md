...
The PHP SDK for the LoremPicsum API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetRandomImage(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->LoremPicsum(null)->load(
    ["id" => "test01"], null
);
