...
// LoremPicsum SDK telemetry feature
...
class LoremPicsumTelemetryFeature extends LoremPicsumBaseFeature
{
    ...
    private function _close(LoremPicsumContext $ctx, bool $ok): void
    {
