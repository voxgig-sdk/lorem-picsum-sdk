...
class LoremPicsumProxyFeature extends LoremPicsumBaseFeature
{
    ...
    public function init(LoremPicsumContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LoremPicsumContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
