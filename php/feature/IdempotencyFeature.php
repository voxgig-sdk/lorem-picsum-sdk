...
// LoremPicsum SDK idempotency feature
...
class LoremPicsumIdempotencyFeature extends LoremPicsumBaseFeature
{
    ...
    private function _mutating(LoremPicsumContext $ctx): bool
    {
