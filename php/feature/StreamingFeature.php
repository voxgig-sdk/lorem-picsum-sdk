...
// LoremPicsum SDK streaming feature
...
class LoremPicsumStreamingFeature extends LoremPicsumBaseFeature
{
    ...
    private function _iterate(LoremPicsumResult $result): \Generator
    {
    ...
    private function _streamable(LoremPicsumContext $ctx): bool
    {
