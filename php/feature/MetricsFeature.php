...
// LoremPicsum SDK metrics feature
...
class LoremPicsumMetricsFeature extends LoremPicsumBaseFeature
{
    ...
    private function _record(LoremPicsumContext $ctx, bool $ok): void
    {
