...
class LoremPicsumCacheFeature extends LoremPicsumBaseFeature
{
    ...
    private function _through(LoremPicsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
