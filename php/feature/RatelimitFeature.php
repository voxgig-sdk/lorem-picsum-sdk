...
// LoremPicsum SDK ratelimit feature
...
class LoremPicsumRatelimitFeature extends LoremPicsumBaseFeature
{
    ...
    private function _acquire(LoremPicsumContext $ctx): void
    {
    ...
    private function _track(LoremPicsumContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
