...
// LoremPicsum SDK timeout feature
...
class LoremPicsumTimeoutFeature extends LoremPicsumBaseFeature
{
    ...
    private function _with_timeout(LoremPicsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LoremPicsumContext $_ctx, float $ms): void
    {
        $client = $this->client;
