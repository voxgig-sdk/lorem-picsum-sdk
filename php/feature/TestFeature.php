...
// LoremPicsum SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LoremPicsumTestFeature extends LoremPicsumBaseFeature
{
    ...
    public function init(LoremPicsumContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LoremPicsumContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = LoremPicsumParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LoremPicsumContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LoremPicsumContext $ctx, $op, $args): array
    {
