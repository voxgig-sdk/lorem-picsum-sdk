...
class HeightEntity
  ...
  # @return [Height, Hash] the current Height data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Height fields)
  def match_get
  ...
  #
  # @param reqmatch [HeightLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Height.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Height, Hash] the loaded Height; raises LoremPicsumError on failure
