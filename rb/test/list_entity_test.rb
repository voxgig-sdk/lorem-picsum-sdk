...
class ListEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = LoremPicsumSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LOREM_PICSUM_TEST_LIST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def list_basic_setup(extra)
  ...
  entid_env_raw = ENV["LOREM_PICSUM_TEST_LIST_ENTID"]
