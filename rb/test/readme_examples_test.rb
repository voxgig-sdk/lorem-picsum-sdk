...
#      offline in seeded test mode (LoremPicsumSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "LoremPicsum_sdk.rb")
  SDK_CLASS = "LoremPicsumSDK"
