...
|---|---|---|
| `ts/` | @voxgig-sdk/lorem-picsum-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lorem-picsum-sdk \
      --repository voxgig-sdk/lorem-picsum-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lorem-picsum-sdk` shows it, and
`npm trust revoke @voxgig-sdk/lorem-picsum-sdk --id=<id>` removes it.
