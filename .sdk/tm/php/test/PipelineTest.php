...
{
    private static function utility(): LoremPicsumUtility
    {
        return new LoremPicsumUtility();
    }
    ...
    private static function ctx(array $over = []): LoremPicsumContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LoremPicsumContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LoremPicsumOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LoremPicsumError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LoremPicsumOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LoremPicsumMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LoremPicsumOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LoremPicsumMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LoremPicsumOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LoremPicsumMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LoremPicsumSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LoremPicsumMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LoremPicsumResponse([]),
            'result' => new LoremPicsumResult([]),
        ]);
        [, $err] = LoremPicsumMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec([]),
            'response' => null,
            'result' => new LoremPicsumResult([]),
        ]);
        [, $err] = LoremPicsumMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec(['step' => 's']),
            'response' => new LoremPicsumResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LoremPicsumResult([]),
        ]);
        [, $err] = LoremPicsumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec(['step' => 's']),
            'response' => new LoremPicsumResponse(self::resp(200, ['v' => 1])),
            'result' => new LoremPicsumResult([]),
        ]);
        [, $err] = LoremPicsumMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec(['step' => 's']),
            'response' => new LoremPicsumResponse(self::resp(200, ['v' => 2])),
            'result' => new LoremPicsumResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LoremPicsumMakeResponse::call($ctx);
    ...
    {
        $preset = new LoremPicsumResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec([]),
            'response' => new LoremPicsumResponse([]),
            'result' => new LoremPicsumResult([]),
        ...
        [$got, $err] = LoremPicsumMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LoremPicsumResult([])]);
        [, $err] = LoremPicsumMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LoremPicsumSpec([]), 'result' => null]);
        [, $err] = LoremPicsumMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LoremPicsumSpec(['step' => 's']),
            'result' => new LoremPicsumResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LoremPicsumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LoremPicsumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LoremPicsumSpec(['step' => 's']),
            'result' => new LoremPicsumResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LoremPicsumOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LoremPicsumMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LoremPicsumResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LoremPicsumSpec([]),
            'result' => new LoremPicsumResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LoremPicsumMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LoremPicsumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new LoremPicsumError('boom', 'boom');
        $utility->fetcher = function (LoremPicsumContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LoremPicsumSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LoremPicsumMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LoremPicsumContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LoremPicsumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LoremPicsumResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        LoremPicsumMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LoremPicsumContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LoremPicsumSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LoremPicsumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LoremPicsumResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LoremPicsumSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LoremPicsumMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LoremPicsumMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LoremPicsumMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LoremPicsumResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LoremPicsumDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LoremPicsumResult(['ok' => false])]);
        $this->expectException(LoremPicsumError::class);
        LoremPicsumDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LoremPicsumResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LoremPicsumMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        LoremPicsumMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LoremPicsumBaseFeature();
        $b = new LoremPicsumBaseFeature();
        LoremPicsumFeatureAdd::call($ctx, $a);
        LoremPicsumFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LoremPicsumBaseFeature
    {
        $f = new LoremPicsumBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        LoremPicsumFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): LoremPicsumContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LoremPicsumSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = LoremPicsumPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        LoremPicsumPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new LoremPicsumResponse(['headers' => null]),
            'result' => new LoremPicsumResult([]),
        ]);
        LoremPicsumResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        LoremPicsumResultBody::call($ctx);
