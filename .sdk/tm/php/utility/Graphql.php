...
// LoremPicsum SDK utility: graphql
//
...
class LoremPicsumGraphql
{
    ...
    // equivalent.
    public static function body(LoremPicsumContext $ctx): mixed
    {
    ...
    public static function errors(LoremPicsumContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
