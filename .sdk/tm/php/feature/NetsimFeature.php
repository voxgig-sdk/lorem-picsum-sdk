...
// LoremPicsum SDK netsim feature
...
class LoremPicsumNetsimFeature extends LoremPicsumBaseFeature
{
    ...
    private function _simulate(LoremPicsumContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LoremPicsumContext $ctx, array $applied): void
    {
        $client = $this->client;
