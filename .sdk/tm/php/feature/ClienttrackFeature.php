...
// LoremPicsum SDK clienttrack feature
...
class LoremPicsumClienttrackFeature extends LoremPicsumBaseFeature
{
    ...
    public function PostConstruct(LoremPicsumContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LoremPicsum-SDK';
