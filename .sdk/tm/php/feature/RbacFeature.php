...
class LoremPicsumRbacFeature extends LoremPicsumBaseFeature
{
    ...
    private function _required(LoremPicsumContext $ctx): ?string
    {
    ...
    private function _reject(LoremPicsumContext $ctx, string $required): void
    {
    ...
    private function _track(LoremPicsumContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
