...
from projectname_sdk import LoremPicsumSDK
from projectname_sdk.core.spec import LoremPicsumSpec
from projectname_sdk.core.result import LoremPicsumResult
from projectname_sdk.core.response import LoremPicsumResponse
from projectname_sdk.core.operation import LoremPicsumOperation
from projectname_sdk.core.error import LoremPicsumError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import LoremPicsumBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return LoremPicsumError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = LoremPicsumSDK.test(None, None)
        ...
        class TestInitFeature(LoremPicsumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LoremPicsumBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = LoremPicsumSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LoremPicsumSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = LoremPicsumOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LoremPicsumSDK.test(None, setup_opts)
