...
_runner = makeRunner(TEST_JSON_FILE, LoremPicsumSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LoremPicsumSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LoremPicsumSDK.test(None, setup.get('a') or {})
