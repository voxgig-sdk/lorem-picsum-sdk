...
const testSeed = `map[string]any{"entity": map[string]any{"get_random_image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_random_square_image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "height": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "heightwebp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "id_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "idn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "seed": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "seed_info": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
