...
func TestHeightwebpEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		heightwebpRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.heightwebp")))
...
func heightwebpBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LOREM_PICSUM_TEST_HEIGHTWEBP_ENTID")
	...
	idmapResolved := core.ToMapAny(env["LOREM_PICSUM_TEST_HEIGHTWEBP_ENTID"])
