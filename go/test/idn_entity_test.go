...
func TestIdnEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		idnRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.idn")))
...
func idnBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LOREM_PICSUM_TEST_IDN_ENTID")
	...
	idmapResolved := core.ToMapAny(env["LOREM_PICSUM_TEST_IDN_ENTID"])
