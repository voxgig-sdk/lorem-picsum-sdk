...
func NewSeedInfoEntity(client *core.LoremPicsumSDK, entopts map[string]any) *SeedInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeedInfoEntity) GetName() string { return e.name }
...
func (e *SeedInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeedInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *SeedInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeedInfoEntity(e.client, opts)
}

func (e *SeedInfoEntity) Data(args ...any) any {
...
func (e *SeedInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SeedInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SeedInfoEntity) DataTyped(data ...SeedInfo) SeedInfo {
	if len(data) > 0 {
		return typedFrom[SeedInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[SeedInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SeedInfo (all fields
// optional at the wire level).
func (e *SeedInfoEntity) MatchTyped(match ...SeedInfo) SeedInfo {
	if len(match) > 0 {
		return typedFrom[SeedInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[SeedInfo](e.Match())
}
...
func (e *SeedInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeedInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SeedInfoLoadMatch and returns an SeedInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SeedInfoEntity) LoadTyped(reqmatch SeedInfoLoadMatch, ctrl map[string]any) (SeedInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SeedInfo{}, err
	}
	return typedFrom[SeedInfo](res), nil
}



func (e *SeedInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SeedInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeedInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeedInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeedInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
