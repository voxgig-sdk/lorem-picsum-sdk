...
func NewIdInfoEntity(client *core.LoremPicsumSDK, entopts map[string]any) *IdInfoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdInfoEntity) GetName() string { return e.name }
...
func (e *IdInfoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdInfoEntity) Deleted() bool {
	return e.deleted
}


func (e *IdInfoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdInfoEntity(e.client, opts)
}

func (e *IdInfoEntity) Data(args ...any) any {
...
func (e *IdInfoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IdInfo; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdInfoEntity) DataTyped(data ...IdInfo) IdInfo {
	if len(data) > 0 {
		return typedFrom[IdInfo](e.Data(asMap(data[0])))
	}
	return typedFrom[IdInfo](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IdInfo (all fields
// optional at the wire level).
func (e *IdInfoEntity) MatchTyped(match ...IdInfo) IdInfo {
	if len(match) > 0 {
		return typedFrom[IdInfo](e.Match(asMap(match[0])))
	}
	return typedFrom[IdInfo](e.Match())
}
...
func (e *IdInfoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdInfoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdInfoLoadMatch and returns an IdInfo. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IdInfoEntity) LoadTyped(reqmatch IdInfoLoadMatch, ctrl map[string]any) (IdInfo, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return IdInfo{}, err
	}
	return typedFrom[IdInfo](res), nil
}



func (e *IdInfoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IdInfoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IdInfoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IdInfoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IdInfoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
