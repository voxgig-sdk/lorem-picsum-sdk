...
func NewSeedEntity(client *core.LoremPicsumSDK, entopts map[string]any) *SeedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SeedEntity) GetName() string { return e.name }
...
func (e *SeedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SeedEntity) Deleted() bool {
	return e.deleted
}


func (e *SeedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSeedEntity(e.client, opts)
}

func (e *SeedEntity) Data(args ...any) any {
...
func (e *SeedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *SeedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SeedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SeedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SeedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SeedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SeedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
