...
func NewHeightwebpEntity(client *core.LoremPicsumSDK, entopts map[string]any) *HeightwebpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HeightwebpEntity) GetName() string { return e.name }
...
func (e *HeightwebpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HeightwebpEntity) Deleted() bool {
	return e.deleted
}


func (e *HeightwebpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHeightwebpEntity(e.client, opts)
}

func (e *HeightwebpEntity) Data(args ...any) any {
...
func (e *HeightwebpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Heightwebp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HeightwebpEntity) DataTyped(data ...Heightwebp) Heightwebp {
	if len(data) > 0 {
		return typedFrom[Heightwebp](e.Data(asMap(data[0])))
	}
	return typedFrom[Heightwebp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Heightwebp (all fields
// optional at the wire level).
func (e *HeightwebpEntity) MatchTyped(match ...Heightwebp) Heightwebp {
	if len(match) > 0 {
		return typedFrom[Heightwebp](e.Match(asMap(match[0])))
	}
	return typedFrom[Heightwebp](e.Match())
}
...
func (e *HeightwebpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HeightwebpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HeightwebpLoadMatch and returns an Heightwebp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HeightwebpEntity) LoadTyped(reqmatch HeightwebpLoadMatch, ctrl map[string]any) (Heightwebp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Heightwebp{}, err
	}
	return typedFrom[Heightwebp](res), nil
}



func (e *HeightwebpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HeightwebpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HeightwebpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HeightwebpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HeightwebpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
