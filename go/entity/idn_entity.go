...
func NewIdnEntity(client *core.LoremPicsumSDK, entopts map[string]any) *IdnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IdnEntity) GetName() string { return e.name }
...
func (e *IdnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IdnEntity) Deleted() bool {
	return e.deleted
}


func (e *IdnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIdnEntity(e.client, opts)
}

func (e *IdnEntity) Data(args ...any) any {
...
func (e *IdnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Idn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IdnEntity) DataTyped(data ...Idn) Idn {
	if len(data) > 0 {
		return typedFrom[Idn](e.Data(asMap(data[0])))
	}
	return typedFrom[Idn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Idn (all fields
// optional at the wire level).
func (e *IdnEntity) MatchTyped(match ...Idn) Idn {
	if len(match) > 0 {
		return typedFrom[Idn](e.Match(asMap(match[0])))
	}
	return typedFrom[Idn](e.Match())
}
...
func (e *IdnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IdnEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IdnLoadMatch and returns an Idn. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IdnEntity) LoadTyped(reqmatch IdnLoadMatch, ctrl map[string]any) (Idn, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Idn{}, err
	}
	return typedFrom[Idn](res), nil
}



func (e *IdnEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IdnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IdnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IdnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IdnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
