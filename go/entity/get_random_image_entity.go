...
type GetRandomImageEntity struct {
	name    string
...
func NewGetRandomImageEntity(client *core.LoremPicsumSDK, entopts map[string]any) *GetRandomImageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRandomImageEntity) GetName() string { return e.name }
...
func (e *GetRandomImageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRandomImageEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRandomImageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRandomImageEntity(e.client, opts)
}

func (e *GetRandomImageEntity) Data(args ...any) any {
...
func (e *GetRandomImageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRandomImage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRandomImageEntity) DataTyped(data ...GetRandomImage) GetRandomImage {
	if len(data) > 0 {
		return typedFrom[GetRandomImage](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRandomImage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRandomImage (all fields
// optional at the wire level).
func (e *GetRandomImageEntity) MatchTyped(match ...GetRandomImage) GetRandomImage {
	if len(match) > 0 {
		return typedFrom[GetRandomImage](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRandomImage](e.Match())
}
...
func (e *GetRandomImageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRandomImageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRandomImageLoadMatch and returns an GetRandomImage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRandomImageEntity) LoadTyped(reqmatch GetRandomImageLoadMatch, ctrl map[string]any) (GetRandomImage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRandomImage{}, err
	}
	return typedFrom[GetRandomImage](res), nil
}



func (e *GetRandomImageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRandomImageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRandomImageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRandomImageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRandomImageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
