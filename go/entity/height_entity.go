...
func NewHeightEntity(client *core.LoremPicsumSDK, entopts map[string]any) *HeightEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HeightEntity) GetName() string { return e.name }
...
func (e *HeightEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HeightEntity) Deleted() bool {
	return e.deleted
}


func (e *HeightEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHeightEntity(e.client, opts)
}

func (e *HeightEntity) Data(args ...any) any {
...
func (e *HeightEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Height; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HeightEntity) DataTyped(data ...Height) Height {
	if len(data) > 0 {
		return typedFrom[Height](e.Data(asMap(data[0])))
	}
	return typedFrom[Height](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Height (all fields
// optional at the wire level).
func (e *HeightEntity) MatchTyped(match ...Height) Height {
	if len(match) > 0 {
		return typedFrom[Height](e.Match(asMap(match[0])))
	}
	return typedFrom[Height](e.Match())
}
...
func (e *HeightEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HeightEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HeightLoadMatch and returns an Height. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HeightEntity) LoadTyped(reqmatch HeightLoadMatch, ctrl map[string]any) (Height, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Height{}, err
	}
	return typedFrom[Height](res), nil
}



func (e *HeightEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *HeightEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HeightEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HeightEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HeightEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
