...
func (sdk *LoremPicsumSDK) OptionsMap() map[string]any {
...
func (sdk *LoremPicsumSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *LoremPicsumSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *LoremPicsumSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LoremPicsumSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *LoremPicsumSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *LoremPicsumSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("LoremPicsumSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *LoremPicsumSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LoremPicsumSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("LoremPicsumSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
