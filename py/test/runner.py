...
class LoremPicsumTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LoremPicsumTestRunner.getenv("LOREMPICSUM_TEST_LIVE")
        override = LoremPicsumTestRunner.getenv("LOREMPICSUM_TEST_OVERRIDE")
        ...
        explain = LoremPicsumTestRunner.getenv("LOREMPICSUM_TEST_EXPLAIN")
