# LoremPicsum SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LoremPicsumSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LoremPicsumSDK(...) and LoremPicsumSDK.test(...) become
#      LoremPicsumSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "lorempicsum_sdk"
_SDK_CLASS = "LoremPicsumSDK"
...
_ENTITIES = {
    ...
    "GetRandomSquareImage": "get_random_square_image",
    "Height": "height",
    "Heightwebp": "heightwebp",
    "IdInfo": "id_info",
    "Idn": "idn",
    "List": "list",
    "Seed": "seed",
