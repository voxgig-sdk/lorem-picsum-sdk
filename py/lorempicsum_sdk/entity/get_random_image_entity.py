...
class GetRandomImageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomImageEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomImage:
    ...
    def match_get(self) -> GetRandomImage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomImage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomImage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
