...
from lorempicsum_sdk.lorempicsum_types import (
...
class GetRandomSquareImageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomSquareImageEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomSquareImage:
    ...
    def match_get(self) -> GetRandomSquareImage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetRandomSquareImage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetRandomSquareImage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
