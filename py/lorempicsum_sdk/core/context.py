...
from lorempicsum_sdk.core.control import LoremPicsumControl
...
from lorempicsum_sdk.core.helpers import get_ctx_prop, to_map
...
class LoremPicsumContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, LoremPicsumSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LoremPicsumResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LoremPicsumResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LoremPicsumError(code, msg, self)
