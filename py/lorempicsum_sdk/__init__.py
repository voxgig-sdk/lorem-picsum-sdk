...
from lorempicsum_sdk.utility import register

# Load features
from lorempicsum_sdk.feature.base_feature import LoremPicsumBaseFeature
from lorempicsum_sdk.features import _has_feature, _make_feature
...
class LoremPicsumSDK:
    ...
    def __init__(self, options=None):
        ...
        from lorempicsum_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "LoremPicsumSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LoremPicsumSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomImage(self, data=None) -> "GetRandomImageEntity":
        ...
        from lorempicsum_sdk.entity.get_random_image_entity import GetRandomImageEntity
    ...
    def GetRandomSquareImage(self, data=None) -> "GetRandomSquareImageEntity":
        ...
        from lorempicsum_sdk.entity.get_random_square_image_entity import GetRandomSquareImageEntity
    ...
    def Height(self, data=None) -> "HeightEntity":
        ...
        from lorempicsum_sdk.entity.height_entity import HeightEntity
    ...
    def Heightwebp(self, data=None) -> "HeightwebpEntity":
        ...
        from lorempicsum_sdk.entity.heightwebp_entity import HeightwebpEntity
    ...
    def SeedInfo(self, data=None) -> "SeedInfoEntity":
        ...
        from lorempicsum_sdk.entity.seed_info_entity import SeedInfoEntity
