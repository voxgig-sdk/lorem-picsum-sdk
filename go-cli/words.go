...
func registerSDKWords(r *eng.Registry, client *sdk.LoremPicsumSDK) {
...
func runOp(client *sdk.LoremPicsumSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
