...
AQL-driven CLI and REPL for the LoremPicsum SDK. Positional arguments are
...
./lorem-picsum-cli list get_random_image
./lorem-picsum-cli load 1 get_random_image
./lorem-picsum-cli load '{id:1}' get_random_image
