...
local GetRandomImageEntity = {}
GetRandomImageEntity.__index = GetRandomImageEntity


function GetRandomImageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomImageEntity)
  self._name = "get_random_image"
  self._client = client
...
function GetRandomImageEntity:get_name()
  return self._name
end


function GetRandomImageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomImageEntity.new(self._client, opts)
end
...
function GetRandomImageEntity:mark_deleted()
  self._deleted = true
end


function GetRandomImageEntity:deleted()
  return true == self._deleted
end


function GetRandomImageEntity:data_set(args)
  if args ~= nil then
...
function GetRandomImageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomImageEntity:match_set(args)
  if args ~= nil then
...
function GetRandomImageEntity:match_get()
...
function GetRandomImageEntity:stream(action, args, callopts)
...
function GetRandomImageEntity:_run_op(ctx, post_done)
  local utility = self._utility
