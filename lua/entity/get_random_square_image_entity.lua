...
local GetRandomSquareImageEntity = {}
GetRandomSquareImageEntity.__index = GetRandomSquareImageEntity


function GetRandomSquareImageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomSquareImageEntity)
  self._name = "get_random_square_image"
  self._client = client
...
function GetRandomSquareImageEntity:get_name()
  return self._name
end


function GetRandomSquareImageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomSquareImageEntity.new(self._client, opts)
end
...
function GetRandomSquareImageEntity:mark_deleted()
  self._deleted = true
end


function GetRandomSquareImageEntity:deleted()
  return true == self._deleted
end


function GetRandomSquareImageEntity:data_set(args)
  if args ~= nil then
...
function GetRandomSquareImageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomSquareImageEntity:match_set(args)
  if args ~= nil then
...
function GetRandomSquareImageEntity:match_get()
...
function GetRandomSquareImageEntity:stream(action, args, callopts)
...
---@param reqmatch GetRandomSquareImageLoadMatch
---@param ctrl? table
---@return GetRandomSquareImage
---@return string? err
function GetRandomSquareImageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetRandomSquareImageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetRandomSquareImageEntity
