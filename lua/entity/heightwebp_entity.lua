...
local HeightwebpEntity = {}
HeightwebpEntity.__index = HeightwebpEntity


function HeightwebpEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HeightwebpEntity)
  self._name = "heightwebp"
  self._client = client
...
function HeightwebpEntity:get_name()
  return self._name
end


function HeightwebpEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HeightwebpEntity.new(self._client, opts)
end
...
function HeightwebpEntity:mark_deleted()
  self._deleted = true
end


function HeightwebpEntity:deleted()
  return true == self._deleted
end


function HeightwebpEntity:data_set(args)
  if args ~= nil then
...
function HeightwebpEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HeightwebpEntity:match_set(args)
  if args ~= nil then
...
function HeightwebpEntity:match_get()
...
function HeightwebpEntity:stream(action, args, callopts)
...
---@param reqmatch HeightwebpLoadMatch
---@param ctrl? table
---@return Heightwebp
---@return string? err
function HeightwebpEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function HeightwebpEntity:_run_op(ctx, post_done)
  local utility = self._utility
