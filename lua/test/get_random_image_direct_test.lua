...
describe("GetRandomImageDirect", function()
  it("should direct-load-get_random_image", function()
    local setup = get_random_image_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_random_image", setup.live and "live" or "unit")
...
function get_random_image_direct_setup(mockres)
