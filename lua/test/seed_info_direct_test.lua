...
describe("SeedInfoDirect", function()
  it("should direct-load-seed_info", function()
    local setup = seed_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-seed_info", setup.live and "live" or "unit")
...
function seed_info_direct_setup(mockres)
