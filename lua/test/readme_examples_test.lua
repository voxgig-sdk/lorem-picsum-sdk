...
local SDK_MODULE = "lorem-picsum_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["get_random_image"] = { ["test01"] = { id = "test01" } }, ["get_random_square_image"] = { ["test01"] = { id = "test01" } }, ["height"] = { ["test01"] = { id = "test01" } }, ["heightwebp"] = { ["test01"] = { id = "test01" } }, ["id_info"] = { ["test01"] = { id = "test01" } }, ["idn"] = { ["test01"] = { id = "test01" } }, ["list"] = { ["test01"] = { id = "test01" } }, ["seed"] = { ["test01"] = { id = "test01" } }, ["seed_info"] = { ["test01"] = { id = "test01" } } } }'
