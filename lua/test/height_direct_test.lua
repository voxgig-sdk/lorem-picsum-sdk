...
describe("HeightDirect", function()
  it("should direct-load-height", function()
    local setup = height_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-height", setup.live and "live" or "unit")
...
function height_direct_setup(mockres)
