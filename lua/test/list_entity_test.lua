...
describe("ListEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set LOREM_PICSUM_TEST_LIST_ENTID JSON to run live")
      return
    end
...
function list_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("LOREM_PICSUM_TEST_LIST_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["LOREM_PICSUM_TEST_LIST_ENTID"])
