...
describe("SeedDirect", function()
  it("should direct-load-seed", function()
    local setup = seed_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-seed", setup.live and "live" or "unit")
...
function seed_direct_setup(mockres)
