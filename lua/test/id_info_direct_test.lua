...
describe("IdInfoDirect", function()
  it("should direct-load-id_info", function()
    local setup = id_info_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-id_info", setup.live and "live" or "unit")
...
function id_info_direct_setup(mockres)
