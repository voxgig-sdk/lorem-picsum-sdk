...
describe("IdnDirect", function()
  it("should direct-load-idn", function()
    local setup = idn_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-idn", setup.live and "live" or "unit")
...
function idn_direct_setup(mockres)
