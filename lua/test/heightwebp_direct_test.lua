...
describe("HeightwebpDirect", function()
  it("should direct-load-heightwebp", function()
    local setup = heightwebp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-heightwebp", setup.live and "live" or "unit")
...
function heightwebp_direct_setup(mockres)
