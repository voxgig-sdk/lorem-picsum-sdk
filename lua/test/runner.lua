...
function runner.env_override(m)
  local live = runner.getenv("LOREM_PICSUM_TEST_LIVE")
  local override = runner.getenv("LOREM_PICSUM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LOREM_PICSUM_TEST_EXPLAIN")
