...
function runner.env_override(m)
  local live = runner.getenv("LOREMPICSUM_TEST_LIVE")
  local override = runner.getenv("LOREMPICSUM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("LOREMPICSUM_TEST_EXPLAIN")
