// Command LoremPicsum-mcp is an MCP server exposing the LoremPicsum
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LoremPicsum_list  — list records of an entity
//	LoremPicsum_load  — load a single record of an entity
//
